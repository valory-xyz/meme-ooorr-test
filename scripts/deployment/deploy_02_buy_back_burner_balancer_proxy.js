...
async function main() {
    ...
    const proxyPayload = ethers.utils.defaultAbiCoder.encode(["address[]", "bytes32", "uint256"],
         [[parsedData.olasAddress, parsedData.wethAddress, parsedData.balancerPriceOracleAddress,
    ...
    if (parsedData.contractVerification) {
        ...
        execSync("npx hardhat verify --constructor-args scripts/deployment/verify_02_buy_back_burner_balancer_proxy.js --network " + providerName + " " + buyBackBurnerProxy.address, { encoding: "utf-8" });
    }
}
